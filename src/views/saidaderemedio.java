 ...
 * @author Renata
 */
public class saidaderemedio extends javax.swing.JFrame {

    /**
     * Creates new form estoque
     */
    public saidaderemedio() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if((int)quantidade.getValue() > 0){
            ...
            if(endao.qtdRemedios(rem) < (int)quantidade.getValue()){            
                JOptionPane.showMessageDialog(null, "Não existe essa quantidade de remédios no estoque!");
            }else{
                if(rem != null){
                    if(endao.create(en)){
                        ...
                        JOptionPane.showMessageDialog(null, "Erro ao Concluir!");
                    }
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(saidaderemedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
