...
public final class relatoriodesaida extends javax.swing.JFrame {

    int pagina = 1;
    int qtd_pag = 17;
    public relatoriodesaida() {
        initComponents();
    ...
    public void readJTableForNome(){
        ...
        for (Saida e : sdao.readForNome(pesquisar.getText())) {
            modelo.addRow(new Object[]{
                e.getId(),
                e.getRemedio(),
                e.getData(),
    ...
    private void initComponents() {
        ...
        jLabel7.setText("SAÍDA DE REMÉDIO");
        ...
        jTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Remédio", "Data de Saída", "Hora de Saída", "Quantidade"
            }
        ) {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(labelPagina, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(42, 42, 42))
        );
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        if(jTabela.getSelectedRow() != -1){
            ...
            s.setId((int)jTabela.getValueAt(jTabela.getSelectedRow(), 0));
            s.setData((String)jTabela.getValueAt(jTabela.getSelectedRow(), 2));
            s.setHora((String)jTabela.getValueAt(jTabela.getSelectedRow(), 3));

            new SaidaDAO().update(s);
            readJTable(pagina, qtd_pag);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(relatoriodesaida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
